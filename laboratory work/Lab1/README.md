...
> ##### **Ответ:** Статус интерфейса, скорость, инкапсуляция, "keeplive", режим полногодуплекса, тип ARP и его таймаут, счетчики пакетов (подробне в в ответе на вопрос пункта е.
